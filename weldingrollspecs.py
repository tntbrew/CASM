...
def get_bottom_roll_maximum_diameter(line_id):
    try:
...
def get_jig_measurement(line_id):
    try:
        DbConnection = sqlite3.connect('canlinedb.mdf')
...
class WeldingRollSpecifications:
    def __init__(self, master, username):
        ...
        self.jig_textbox = None
        self.bottom_roll_minimum_profile_depth_textbox = None
        self.bottom_roll_maximum_profile_depth_textbox = None
        self.top_roll_offset_textbox = None
        self.bottom_roll_minimum_diameter_textbox = None
        self.bottom_roll_maximum_diameter_textbox = None
        self.top_roll_profile_minimum_depth_textbox = None
        self.top_roll_profile_maximum_depth_textbox = None
        self.top_roll_minimum_diameter_textbox = None
        self.top_roll_maximum_diameter_textbox = None
    ...
    def create_welding_roll_specs_form(self):
        ...
        self.view_records_button = tk.Button(self.root, text='View All Records', font=fnt)

        self.view_records_button.grid(row=7, column=2, columnspan=2, pady=10, ipadx=190)
