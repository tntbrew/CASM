...
from constants import BACKGROUND, FONT_SIZE, BUTTON_BACKGROUND
...
class ProductionLine:
    def __init__(self, master):
        ...
        self.line_name_textbox = None
        self.save_button = None
        self.line_name_editor_textbox = None
        self.master = master
    ...
    def edit(self):
        ...
        self.save_button = tk.Button(editor, text='UpdateRecord')
    ...
    def add_line_form(self):
        ...
        # Create labels for form
        line_name_label = tk.Label(self.root, text='Line Name:',bg=BACKGROUND, font=FONT_SIZE)
        ...
        edit_button = tk.Button(self.root, text='Edit Record',bg=BUTTON_BACKGROUND, command=lambda: self.edit(), font=FONT_SIZE)
